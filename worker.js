...
@media(max-width:700px){.admin-v13-grid{grid-template-columns:1fr}.admin-v13-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}.admin-v13-table{font-size:11px;min-width:760px}.admin-v13-result{overflow:auto}}
...
<div class="admin-menu-v11" id="adminMenuV11">
    ...
    <button type="button" class="admin-menu-card" id="menuAdministrativoV13">
...
<div class="admin-v13-header">
    ...
    <div class="admin-v13-actions no-print">
        <button type="button" class="admin-v13-btn blue" id="btnAtualizarAdministrativoV13">🔄 Atualizar registros</button>
        <button type="button" class="admin-v13-btn gray" id="btnNovaAdministrativaV13">➕ Nova advertência/notificação</button>
    </div>
</div>

<div class="admin-v13-kpis" id="v13Kpis" style="display:none">
    <div class="admin-v13-kpi active" role="button" tabindex="0" data-v13-kpi="todos" title="Mostrar todos os registros encontrados">
        <strong id="v13TotalMedidas">0</strong><span>Total de registros</span>
    </div>
    <div class="admin-v13-kpi" role="button" tabindex="0" data-v13-kpi="advertencias" title="Mostrar somente Advertências">
        <strong id="v13TotalAdvertencias">0</strong><span>Advertências</span>
    </div>
    <div class="admin-v13-kpi" role="button" tabindex="0" data-v13-kpi="notificacoes" title="Mostrar somente Notificações">
        <strong id="v13TotalNotificacoes">0</strong><span>Notificações</span>
    </div>
    <div class="admin-v13-kpi" role="button" tabindex="0" data-v13-kpi="reincidencias" title="Mostrar registros envolvidos em reincidência">
        <strong id="v13TotalReincidencias">0</strong><span>Unidades com reincidência</span>
    </div>
</div>
<div id="v13FiltroAtivo" class="admin-v13-hint" style="display:none;margin:-4px 0 10px;font-weight:700"></div>
    ...
    <form id="formAdministrativoV13">
        <div class="admin-v13-grid">
            <div>
                ...
                <select id="v13Tipo" class="admin-v13-select" required>
            ...
            <div>
                ...
                <input id="v13DataRegistro" class="admin-v13-input" type="date" required>
            </div>
            <div>
                <label class="admin-v13-label">Data da ocorrência</label>
                <input id="v13DataOcorrencia" class="admin-v13-input" type="date">
            </div>
            <div>
                <label class="admin-v13-label">Chamado relacionado (opcional)</label>
                <select id="v13ProtocoloChamado" class="admin-v13-select">
                    <option value="">— Sem chamado associado —</option>
                </select>
                <div class="admin-v13-hint">O protocolo do chamado fica vinculado ao registro administrativo.</div>
            </div>
            <div>
                <label class="admin-v13-label">Bloco *</label>
                <select id="v13Bloco" class="admin-v13-select" required>
                    <option value="">Selecione...</option>
            ...
            <div>
                ...
                <input id="v13Unidade" class="admin-v13-input" type="text" inputmode="numeric" maxlength="8" placeholder="Ex.: 804" required>
            </div>
            <div>
                <label class="admin-v13-label">Infração / ocorrência *</label>
                <select id="v13Infracao" class="admin-v13-select" required>
                    <option value="">Selecione...</option>
                    <option>Barulho / perturbação do sossego</option>
                    <option>Xixi de cachorro</option>
                    <option>Fumar em área comum</option>
                    <option>Reforma fora do horário permitido</option>
                    <option>Uso inadequado de área comum</option>
                    <option>Descarte irregular de resíduos</option>
                    <option>Outros</option>
                </select>
            </div>
            <div>
                <label class="admin-v13-label">Responsável pelo registro</label>
                <input id="v13Responsavel" class="admin-v13-input" type="text" placeholder="Nome do subsíndico/administrador">
            </div>
            <div class="full">
                <label class="admin-v13-label">Base no Regimento Interno</label>
                <input id="v13BaseRegimento" class="admin-v13-input" type="text" placeholder="Ex.: Art. 23, §2º — Perturbação do sossego">
            </div>
            <div class="full">
                <label class="admin-v13-label">Descrição detalhada *</label>
                <textarea id="v13Descricao" class="admin-v13-textarea" required placeholder="Descreva a ocorrência e a circunstância registrada."></textarea>
            </div>
            <div class="full">
                <label class="admin-v13-label">Observações</label>
                <textarea id="v13Observacoes" class="admin-v13-textarea" style="min-height:65px" placeholder="Informações administrativas adicionais."></textarea>
            </div>
        </div>
        <div class="admin-v13-actions no-print" style="margin-top:12px">
            <button type="submit" class="admin-v13-btn green" id="btnSalvarAdministrativoV13">💾 Registrar medida</button>
            <button type="button" class="admin-v13-btn gray" id="btnCancelarAdministrativoV13">Cancelar</button>
        </div>
    </form>
</div>
...
<div class="admin-v13-card">
    ...
    <div class="admin-v13-grid">
        <div>
            <label class="admin-v13-label">Bloco</label>
            <select id="v13BuscaBloco" class="admin-v13-select">
        ...
        <div>
            <label class="admin-v13-label">Unidade</label>
            <input id="v13BuscaUnidade" class="admin-v13-input" type="text" placeholder="Ex.: 804">
        </div>
        <div class="full admin-v13-actions no-print">
            <button type="button" class="admin-v13-btn blue" id="btnConsultarHistoricoV13">🔎 Consultar histórico</button>
            <button type="button" class="admin-v13-btn gray" id="btnLimparHistoricoV13">Limpar</button>
            <button type="button" class="admin-v13-btn green" id="btnRelatorioUnidadeV13">📄 Relatório da unidade</button>
        </div>
    </div>
...
<div class="admin-v13-card">
    ...
    <div id="v13ListaMedidas" class="admin-v13-result">Carregando...</div>
</div>
    ...
    return `
        ...
        <div class="card">
            ...
            <button
                ...
                onclick="
                    abrirAdministrativoParaChamado(
                        '${encodeURIComponent(
                            chamado.protocolo
                        )}'
                    )
                "
            >
                ⚠️ Gerar Advertência / Notificação
            </button>
...
function renderDashboardV11(){
    ...
    // Normaliza o nome do bloco para aceitar os dois formatos usados no sistema:
    // "2D" e "Bloco 2D".
    const normalizarBlocoDashboardV11=(valor)=>{
        return String(valor||"")
            .trim()
            .toUpperCase()
            .replace(/^BLOCO\s+/, "");
    ...
    const porEscopo=(c)=>{
        if(escopo==="condominio") return true;
        return normalizarBlocoDashboardV11(c.bloco) ===
               normalizarBlocoDashboardV11(escopo);
    };
    ...
    const graficoPizza = (items,total) => {
        ...
        const fatias = items.map(([nome,qtd],i) => {
            ...
            const caminho = items.length === 1
                ? `M ${cx} ${cy-radius} A ${raio} ${raio} 0 1 1 ${cx-0.01} ${cy-radius} L ${cx} ${cy} Z`
...
let urlRelatorioPDFV11 = null;

function gerarPDFV11(){
    // Abre a janela imediatamente, ainda dentro do clique do usuário,
    // para evitar bloqueio de pop-up.
    ...
    // Tela provisória enquanto o relatório é montado.
    try{
        w.document.open();
        w.document.write(`
            <!DOCTYPE html>
        ...
        console.error("Erro ao preparar a janela do relatório:",e);
    }

    try{
        // Atualiza os dados do dashboard com os filtros atualmente selecionados.
        renderDashboardV11();

        // Monta o HTML completo do relatório sem abrir outra janela.
        const htmlRel = gerarRelatorioHTMLV11(false);

        if(!htmlRel){
            alert("Não foi possível montar o relatório.");
            return;
        }

        // Em vez de document.write() na janela final, usa um Blob URL.
        // Isso evita problemas de carregamento/execução da impressão em
        // páginas geradas dinamicamente.
        const blob = new Blob([htmlRel], {type:"text/html;charset=utf-8"});
        const url = URL.createObjectURL(blob);

        // Libera a URL anterior, se houver.
        if(urlRelatorioPDFV11){
            try{ URL.revokeObjectURL(urlRelatorioPDFV11); }catch(e){}
        }
        urlRelatorioPDFV11 = url;

        let impressaoIniciada = false;

        const abrirImpressao = function(){
            ...
            try{
                ...
                alert("O relatório foi aberto, mas a impressão automática não pôde ser iniciada. Use Ctrl+P ou o menu Imprimir.");
            }
        };

        // Aguarda o carregamento completo do documento, incluindo imagens/logo,
        // antes de chamar print().
        w.onload = function(){
            const aguardarImagens = function(){
                const imagens = Array.from(w.document.images || []);
                if(!imagens.length){
                    setTimeout(abrirImpressao, 250);
                    return;
                }

                let pendentes = imagens.filter(img => !img.complete);
                if(!pendentes.length){
                    setTimeout(abrirImpressao, 250);
                    return;
                }

                let restante = pendentes.length;
                const pronto = function(){
                    restante--;
                    if(restante <= 0) setTimeout(abrirImpressao, 250);
                };
        ...
        // Navega a janela já autorizada para o relatório final.
        w.location.href = url;
        w.focus();

        // Fallback para navegadores que não disparem onload como esperado.
        setTimeout(function(){
            if(!impressaoIniciada) abrirImpressao();
        }, 1800);

        // Não revoga imediatamente: o navegador precisa manter o Blob disponível
        // durante a impressão.
        setTimeout(function(){
            if(urlRelatorioPDFV11 === url){
                try{ URL.revokeObjectURL(url); }catch(e){}
                urlRelatorioPDFV11 = null;
            }
        }, 60000);
        ...
        alert("Ocorreu um erro ao montar o relatório. A página principal foi preservada. Tente novamente.");
    }
}
...
(function(){
    ...
    function mostrarPesquisaAdminV11(){
        ...
        // The existing V1.0 search/list functions remain responsible for loading data.
        ...
        // Reveal the existing search/filter/list controls after the load handler has run.
        setTimeout(function(){
            const ids = ["estatisticas","filtros","listaChamados"];
            ids.forEach(function(id){
                const el = document.getElementById(id);
                if(el) el.style.display = id === "listaChamados" ? "block" : "block";
            });
        }, 500);
    }
...
(function(){
    ...
    function renderLista(regs=medidas){
        ...
        lista.innerHTML=`<table class="admin-v13-table"><thead><tr><th>Protocolo</th><th>Data</th><th>Unidade</th><th>Tipo</th><th>Infração</th><th>Chamado</th><th>Ações</th></tr></thead><tbody>${regs.map(x=>`<tr>
            ...
            <td>${x.protocoloChamado?`<span class="admin-v13-protocol">${esc(x.protocoloChamado)}</span>`:'—'}</td>
    ...
    let adm13RegistroModalAtual = null;
    function verRegistro(protocolo){
        ...
        set('adm13ModalData',formatarData(x.dataRegistro));
    ...
    function imprimirMedidaAdm13(){
        ...
        if(!x) return;
        const tipo = x.tipo === 'Notificação' ? 'NOTIFICAÇÃO' : 'ADVERTÊNCIA';
        const esc = (v)=>String(v ?? '').replace(/[&<>\"]/g, c => ({'&':'&amp;','<':'&lt;','>':'&gt;','\"':'&quot;'}[c]));
        const w=window.open('', '_blank', 'width=900,height=800');
        if(!w){ alert('O navegador bloqueou a janela de impressão. Permita pop-ups para este site.'); return; }
        w.document.write(`<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><title>${esc(tipo)} - ${esc(x.protocolo)}</title><style>
            *{box-sizing:border-box} body{font-family:Arial,Helvetica,sans-serif;margin:0;padding:35px;color:#183447;background:#fff}
            .cab{border-bottom:3px solid #176b35;padding-bottom:14px;margin-bottom:24px}.cab h1{margin:0;color:#176b35;font-size:22px}.cab h2{margin:6px 0 0;font-size:18px}.sub{color:#667;margin-top:5px;font-size:13px}
            .grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.item{border:1px solid #d9e1e6;border-radius:8px;padding:10px}.full{grid-column:1/-1}.lab{font-size:11px;color:#687680;font-weight:bold;margin-bottom:5px}.val{font-size:14px;font-weight:600;white-space:pre-wrap;word-break:break-word;min-height:18px}
            .assin{margin-top:70px;display:grid;grid-template-columns:1fr 1fr;gap:60px;text-align:center}.linha{border-top:1px solid #333;padding-top:7px;font-size:12px}.rod{margin-top:30px;color:#777;font-size:11px;text-align:center}
            @media print{body{padding:18mm}.no-print{display:none}}
        </style></head><body>
        <div class="cab"><h1>SISTEMA DE GESTÃO DO CONDOMÍNIO</h1><h2>${esc(tipo)}</h2><div class="sub">Protocolo ${esc(x.protocolo)}</div></div>
        <div class="grid">
          <div class="item"><div class="lab">Protocolo</div><div class="val">${esc(x.protocolo)}</div></div>
          <div class="item"><div class="lab">Tipo</div><div class="val">${esc(x.tipo)}</div></div>
          <div class="item"><div class="lab">Data do registro</div><div class="val">${esc(formatarData(x.dataRegistro))}</div></div>
          <div class="item"><div class="lab">Unidade / Bloco</div><div class="val">${esc((x.unidade||'—')+' / '+(x.bloco||'—'))}</div></div>
          <div class="item full"><div class="lab">Infração / Ocorrência</div><div class="val">${esc(x.infracao||'Não informado')}</div></div>
          <div class="item"><div class="lab">Base no Regimento</div><div class="val">${esc(x.baseRegimento||'Não informado')}</div></div>
          <div class="item"><div class="lab">Responsável</div><div class="val">${esc(x.responsavel||'Não informado')}</div></div>
          <div class="item full"><div class="lab">Descrição</div><div class="val">${esc(x.descricao||'Não informado')}</div></div>
          <div class="item full"><div class="lab">Observações</div><div class="val">${esc(x.observacoes||'Não informado')}</div></div>
          <div class="item full"><div class="lab">Chamado relacionado</div><div class="val">${esc(x.protocoloChamado||'Não associado')}</div></div>
        </div>
        <div class="assin"><div class="linha">Responsável pela administração</div><div class="linha">Ciente / assinatura do responsável pela unidade</div></div>
        <div class="rod">Documento emitido pelo Sistema de Gestão do Condomínio.</div>
    ...
    async function carregarMedidas(){
        ...
        try{
            ...
            console.error('V1.3 - erro ao listar Advertências/Notificações:', e);
    ...
    async function salvar(e){
        ...
        if(!payload.tipo||!payload.bloco||!payload.unidade||!payload.infracao||!payload.descricao){alert('Preencha os campos obrigatórios.');return;}
    ...
    function relatorioUnidade(){
        ...
        if(!bloco||!unidade){alert('Consulte primeiro o bloco e a unidade.');return;}
        const regs=medidas.filter(x=>x.bloco===bloco&&x.unidade===unidade);
        const w=window.open('','_blank');
        if(!w){alert('O navegador bloqueou a nova janela. Permita pop-ups para gerar o relatório.');return;}
        const rows=regs.map(x=>`<tr><td>${esc(x.dataRegistro)}</td><td>${esc(x.protocolo)}</td><td>${esc(x.tipo)}</td><td>${esc(x.infracao)}</td><td>${esc(x.protocoloChamado||'—')}</td></tr>`).join('');
        w.document.write(`<!doctype html><html><head><meta charset="utf-8"><title>Histórico ${esc(unidade)}/${esc(bloco)}</title><style>body{font-family:Arial,sans-serif;color:#18313f;margin:30px}h1{color:#123b5d}table{width:100%;border-collapse:collapse}th{background:#123b5d;color:#fff;text-align:left;padding:8px}td{border:1px solid #ccd7dc;padding:7px;font-size:12px}.box{border:1px solid #d6e0e5;border-radius:8px;padding:12px;margin:12px 0} @media print{button{display:none}}</style></head><body><img src="${location.origin}/logo parqueclube.png" style="max-width:180px"><h1>Histórico de Advertências / Notificações</h1><div class="box"><strong>Unidade:</strong> ${esc(unidade)} &nbsp; <strong>Bloco:</strong> ${esc(bloco)}<br><strong>Total de registros:</strong> ${regs.length}</div><table><thead><tr><th>Data</th><th>Protocolo</th><th>Tipo</th><th>Infração</th><th>Chamado relacionado</th></tr></thead><tbody>${rows||'<tr><td colspan="5">Nenhum registro encontrado.</td></tr>'}</tbody></table><div class="box"><strong>Observação:</strong> documento destinado ao acompanhamento administrativo da unidade.</div><button onclick="window.print()">🖨️ Imprimir / Salvar PDF</button></body></html>`);w.document.close();setTimeout(()=>w.print(),500);
    }
    async function abrir(){
        ...
        try{
            ...
            console.warn('V1.3 TESTE: chamados não disponíveis no D1 de teste. O cadastro administrativo continuará funcionando sem vínculo de chamado.', e);
            chamados = [];
            chamadosArquivadosV11 = [];
            carregarChamadosSelect();
        }
    ...
    document.getElementById('btnVoltarAdminMenu')?.addEventListener('click',()=>{ if(admin) admin.style.display='none'; });
...
<div id="adm13DetalhesModal" class="admin-v13-modal" aria-hidden="true">
    <div class="admin-v13-modal-box" role="dialog" aria-modal="true" aria-labelledby="adm13ModalTitulo">
        <div class="admin-v13-modal-head">
            <div id="adm13ModalTitulo" class="admin-v13-modal-title">⚠️ Detalhes da Advertência</div>
            <button type="button" id="btnFecharAdm13Modal" class="admin-v13-modal-close" aria-label="Fechar">×</button>
        </div>
        <div class="admin-v13-modal-body">
            <div class="admin-v13-detail-grid">
                <div class="admin-v13-detail">
                    ...
                    <div id="adm13ModalProtocolo" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail">
                    <div class="admin-v13-detail-label">Tipo</div>
                    <div id="adm13ModalTipo" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail">
                    <div class="admin-v13-detail-label">Data do registro</div>
                    <div id="adm13ModalData" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail">
                    <div class="admin-v13-detail-label">Unidade / Bloco</div>
                    <div id="adm13ModalUnidade" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail full">
                    <div class="admin-v13-detail-label">Infração / Ocorrência</div>
                    <div id="adm13ModalInfracao" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail">
                    <div class="admin-v13-detail-label">Base no Regimento</div>
                    <div id="adm13ModalBase" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail">
                    <div class="admin-v13-detail-label">Responsável</div>
                    <div id="adm13ModalResponsavel" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail full">
                    <div class="admin-v13-detail-label">Descrição</div>
                    <div id="adm13ModalDescricao" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail full">
                    <div class="admin-v13-detail-label">Observações</div>
                    <div id="adm13ModalObservacoes" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail full">
                    <div class="admin-v13-detail-label">🔗 Chamado relacionado</div>
                    <div id="adm13ModalChamado" class="admin-v13-detail-value"></div>
                </div>
                <div class="admin-v13-detail full">
                    <div class="admin-v13-detail-label">Histórico da unidade</div>
                    <div id="adm13ModalHistorico" class="admin-v13-detail-value"></div>
                </div>
            </div>
            <div class="admin-v13-modal-footer">
                <button type="button" id="btnAbrirChamadoAdm13" class="admin-v13-btn blue" style="display:none">🔎 Consultar chamado relacionado</button>
                <button type="button" id="btnImprimirAdm13Modal" class="admin-v13-btn green">🖨️ Imprimir</button>
                <button type="button" id="btnFecharAdm13Modal2" class="admin-v13-btn gray">Fechar</button>
            </div>
        </div>
    </div>
</div>
